...
const General = React.lazy(() => import("../componentsMedia/settings/General"));
const SecurityAndLogin = React.lazy(() =>
  import("../componentsMedia/settings/SecurityAndLogin")
);

const Location = React.lazy(() =>
  import("../componentsMedia/settings/Location")
);
